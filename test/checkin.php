...
<div class="row"><!--col-xs-12 > row inside responsive column-xs-12, -->
    <div class="col-sm-12"><!--col-sm-12 This is for main header -->
        <div class='page-header'>
            ...
            <p class="label-contrast">Note: An Edit Button Might be added in future besides checkbox
                list, for correcting accidental error</p>
...
$.ajax({
	...
	url        : "checkin.php",
	crossDomain: true,
	data       : { phpjobappid : jobappid, phpjobid : <?php echo $phpjobid; ?> },
	dataType   : 'text',
	timeout	   : 5000
});	
}
